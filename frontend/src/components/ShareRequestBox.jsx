...
export default function ShareRequestBox ({ sender }) {
    ...
    return (
        <div className="mx-auto my-10 p-6 bg-white shadow-md rounded-lg">
          <div className="text-lg font-semibold text-gray-800 mb-5">Send a share request to share each other's passwords with another user</div>
          {errorMsg && (
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-gray-700 text-sm font-semibold mb-2">Receiver:</label>
              <input
