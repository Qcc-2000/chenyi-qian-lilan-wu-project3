...
export default function Login() {
    ...
    return (
        <div className="flex justify-center flex-col items-center">
            <NavBeforeLogin />
            <LoginSignupBox title='Log in' username={username} setUsername={setUsername} password={password} setPassword={setPassword} errorMsg={errorMsg} handleSubmit={handleSubmit}/>
        </div>
    );
}
